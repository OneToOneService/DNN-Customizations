...
<!--If you want to apply another existing color theme
    ...
    or create your one
    -->
<link rel="stylesheet" href="<%= TemplateSourceDirectory %>/css/color_themes/default.css" media="screen" />

<link rel="stylesheet" href="//fonts.googleapis.com/css?family=Open+Sans:400,600,300,800,700,400italic|PT+Serif:400,400italic" />
<link rel="stylesheet" href="<%= TemplateSourceDirectory %>/css/fancybox.min.css"
    media="screen" />
<link rel="stylesheet" href="<%= TemplateSourceDirectory %>/css/mediaelementplayer.min.css"
    media="screen" />
<!--<![endif]-->
<!--[if lte IE 6]>
...
<section class="container clearfix" style="margin-top:30px;">
   <header class="page-header" style="margin-bottom:0; border-bottom:none;">
		<h2 class="page-title"><%= PortalSettings.ActiveTab.TabName %> : <%= PortalSettings.ActiveTab.Title%></h2>	
...
<%----------------------------------- JAVA SCRIPT ----%>
<%--- Custom Scripts ----%>
<%--<script src="<%= TemplateSourceDirectory %>/js/jquery-1.7.1.min.js"></script>--%>
...
<!--[if !lte IE 6]><!-->
	...
	<script id='js-dispatcher' src="<%= TemplateSourceDirectory %>/js/custom.js"></script>
