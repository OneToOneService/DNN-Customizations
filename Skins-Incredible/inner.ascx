...
<!-- /Chat Badge -->
    ...
    <header class="page-header">
		...
		<div style="padding: 10px; border: 1px solid #586f8c; background-image: url('/portals/1to1service/Images/banner-background.png'); background-repeat: repeat-x; background-color: #ebebeb;">
