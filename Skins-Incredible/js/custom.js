...
jQuery(document).ready(function ($) {
    ...
    yepnope({
        ...
        yep: scriptsPath + '/jquery.twitter.feed.js',
        callback: function () {
            $.getJSON(skinPath + "/CommonParts/TwitterHandler.ashx?screen_name=iServiceNews", function (yourRawJSONData) {

                $(".widget-tweets .widget-content").twitterFeed({
                    count: 3,
